...
namespace Terraria
{
    ...
    abstract class Entity : Transformable, Drawable
    {
        ...
        private void updatePhysics()
        {
            ...
            if (!isGhost)
            {
                ...
                for (int step = 0; step < countStep; step++)
                {
                    ...
                    if (topTile != null)
                    {
                        FloatRect tileRect = new FloatRect(topTile.Position, new Vector2f(Tile.TILE_SIZE, Tile.TILE_SIZE));
        ...
        bool updateCollision(FloatRect rectNPC, FloatRect rectTile, DirectionType dir, ref Vector2f pos)
        {
